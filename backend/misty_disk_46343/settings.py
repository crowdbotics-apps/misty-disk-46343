"""
Django settings for misty_disk_46343 project.
...
ROOT_URLCONF = 'misty_disk_46343.urls'
...
WSGI_APPLICATION = 'misty_disk_46343.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "misty_disk_46343 API",
    "DESCRIPTION": "API documentation for misty_disk_46343 App",
    "VERSION": "v1",
}
